...
class ACAgent_MC():
    ...
    def update(self, states, actions, rewards):
        ...
        actor_loss = (-log_probs * state_value.detach()).mean()
        critic_loss = ((returns - state_value) ** 2).mean()
...
def train_AC_MC(params, device):
    ...
    agent = ACAgent_MC(n_observations, n_actions, device, params)
    eval_returns = []
